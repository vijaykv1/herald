...
class ContextInterface(abc.ABC):
    ...
    @staticmethod
    def guardrail(name: str) -> str:
        """Guardrail instructions to ensure the Agent stays on topic and doesn't hallucinate.

        :return: Guardrail instructions for the Agent
        :rtype: str
        """
        return f"""
